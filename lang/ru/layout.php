...
return [
    ...
    'form_label_name'  => 'Имя',
    'navbar_logo_text' => 'Менеджер задач',
    'navbar_login' => 'Вход',
    'navbar_logout' => 'Выход',
    'navbar_register'  => 'Регистрация',
    'navbar_tasks'  => 'Задачи',
    'navbar_task_statuses'  => 'Статусы',
    'navbar_task_tags'  => 'Метки',
    'table_header_id'  => 'ID',
    'table_header_name'  => 'Имя',
    'table_header_created_at'  => 'Дата создания',
    'table_header_actions'  => 'Действия',
    'task_status_index_header'  => 'Статусы',
    'task_status_create_header'  => 'Создать статус',
    'task_status_create_link'  => 'Создать статус',
    'task_status_create_flash_success' => 'Статус успешно создан',
    'task_status_store_button'  => 'Создать',
    'task_status_edit_header'  => 'Изменение статуса',
    'task_status_edit_link'  => 'Изменить',
    'task_status_update_button'  => 'Обновить',
